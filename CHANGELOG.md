...
- OpenAI provider streaming and non-streaming tool call parsers now handle flattened response formats from API proxies (e.g., OmniRoute) that translate between Chat Completions and Responses API formats
